          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                ...
                <div className="hidden sm:flex">
                  <a
                    className="hover:cursor-pointer rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 dark:bg-gray-800 dark:text-white dark:hover:text-white/75"
                  >
                    Logout
                  </a>
                </div>
